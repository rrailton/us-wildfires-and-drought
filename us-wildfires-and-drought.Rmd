...
```{r, loading-wildfires, tidy='styler', tidy.opts=list(strict=FALSE)}
...
```{r, transform, tidy='styler', tidy.opts=list(strict=FALSE)}
...
```{r, histograms, tidy='styler', tidy.opts=list(strict=FALSE)}
# Histograms
...
```{r, boxplots, tidy='styler', tidy.opts=list(strict=FALSE)}
...
```
# Visualizations
```{r, visualizations, tidy='styler', tidy.opts=list(strict=FALSE)}
glimpse(fires_new)
...
```
```{r, fire-causes, tidy='styler', tidy.opts=list(strict=FALSE)}
# Fires Causes
...
```{r, correlation-matrix-attributes, tidy='styler', tidy.opts=list(strict=FALSE)}
# US fires
...
```{r, fire-size-spei-linear-regression, tidy='styler', tidy.opts=list(strict=FALSE)}
# CA FIRE_SIZE & SPEI
...
```{r, fire-freq-spei-linear-regression, tidy='styler', tidy.opts=list(strict=FALSE)}
# CA FIRE_FREQ & SPEI
...
```{r, fire-area-spei-linear-regression, tidy='styler', tidy.opts=list(strict=FALSE)}
# CA FIRE_AREA & SPEI
...
```{r, fires-large-spei-linear-regression, tidy='styler', tidy.opts=list(strict=FALSE)}
...
```{r, multiple-linear-regression, tidy='styler', tidy.opts=list(strict=FALSE)}
# merge fa,fs,lf
...
```{r, fire-size-prediction, tidy='styler', tidy.opts=list(strict=FALSE)}
